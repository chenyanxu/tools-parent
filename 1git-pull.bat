...
IF %hasErrors%==0 cd kalix-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of kalix-parent' & pause & goto :EOF

cd ..
IF %hasErrors%==0 cd framework-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of framework-parent' & pause & goto :EOF

cd ..
IF %hasErrors%==0  cd admin-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of admin-parent' & pause & goto :EOF

cd ..
IF %hasErrors%==0  cd middleware-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of middleware-parent' & pause & goto :EOF

cd ..
IF %hasErrors%==0  cd oa-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of oa-parent' & pause & goto :EOF

cd ..
IF %hasErrors%==0  cd common-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of common-parent' & pause & goto :EOF


cd ..
IF %hasErrors%==0  cd schedule-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of schedule-parent' & pause & goto :EOF

cd ..
IF %hasErrors%==0  cd general-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of general-parent' & pause & goto :EOF


cd ..
IF %hasErrors%==0  cd research-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of research-parent' & pause & goto :EOF

cd ..
IF %hasErrors%==0  cd art-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of art-parent' & pause & goto :EOF

cd ..
IF %hasErrors%==0  cd educational-parent & git pull origin master || set hasErrors=1
IF %hasErrors%==1 echo 'An error occurred of educational-parent' & pause & goto :EOF


cd ..
IF %hasErrors%==0  cd tools-parent & git pull origin master || set hasErrors=1
