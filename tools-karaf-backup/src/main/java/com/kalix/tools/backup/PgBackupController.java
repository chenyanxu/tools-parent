 ...
 * @author jgilson
 */
public class PgBackupController {

    public PgBackupController() {
    ...
    public void executeCommand(String databaseName, String databasePassword, String type) {
        ...
        if (!commands.isEmpty()) {
            try {
                ...
                SystemUtil.succeedPrintln("===> Success on " + type + " process.");
            } catch (IOException | InterruptedException ex) {
                SystemUtil.errorPrintln("Exception: " + ex);
            }
        } else {
            SystemUtil.errorPrintln("Error: Invalid params.");
        }
    }
